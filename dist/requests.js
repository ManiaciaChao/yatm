...
exports.tryShortenURL = exports.signIn = exports.activeSign = void 0;
...
exports.tryShortenURL = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    var resp, json, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, node_fetch_1.default("https://v1.alapi.cn/api/url?url=" + encodeURIComponent(url))];
            case 1:
                resp = _a.sent();
                return [4 /*yield*/, resp.json()];
            case 2:
                json = _a.sent();
                return [2 /*return*/, json.data.short_url];
            case 3:
                err_1 = _a.sent();
                console.log(err_1);
                return [2 /*return*/, url];
